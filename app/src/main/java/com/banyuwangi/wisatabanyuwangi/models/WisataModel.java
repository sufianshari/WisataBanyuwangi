...
public class WisataModel {
    ...
    public WisataModel(int idWisata, String nmWisata, String nmKategori, String nmKecamatan, String lokasi, String deskripsi, String latitude, String longitude, String imgWisata) {
